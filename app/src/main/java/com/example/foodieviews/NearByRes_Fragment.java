...
public class NearByRes_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        clients = LocationServices.getFusedLocationProviderClient(getActivity());
    ...
    public void getmylocation() {
        ...
        Task<Location> task = clients.getLastLocation();
